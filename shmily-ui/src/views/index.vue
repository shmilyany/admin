    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="24">
        <blockquote class="text-warning" style="font-size: 14px">
          ...
          <br />
          阿里云服务器折扣区
          <el-link href="http://aly.shmily.vip" type="primary" target="_blank"
            >>☛☛点我进入☚☚</el-link
          >
          &nbsp;&nbsp;&nbsp; 腾讯云服务器秒杀区
          <el-link href="http://txy.shmily.vip" type="primary" target="_blank"
            >>☛☛点我进入☚☚</el-link
          ><br />
      ...
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        ...
        <p>
          ...
          <el-button
            icon="HomeFilled"
            plain
            @click="goTarget('http://shmily.vip')"
            >访问主页</el-button
          >
        </p>
      </el-col>
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 官网：<el-link
                href="http://www.shmily.vip"
                target="_blank"
                >http://www.shmily.vip</el-link
              >
            </p>
            <p>
